...
function progressLevel(score = 0, weeklyTarget = 5) {
  ...
  if (cappedScore >= weeklyTarget) return 1;
...
export default function BodyBrightFigure({ zoneScores = {}, weeklyTarget = 5 }) {
  const [head, upperTorso, midTorso, lowerTorso, arms, legs] = zones;

  return (
    <div className="body-bright-figure compact-body-dashboard">
      <svg
      ...
      >
          ...
          {zones.map((zone) => {
            ...
            return (
              <filter
                ...
                height="240%"
              >
                <feGaussianBlur stdDeviation={strength.softBlur} result="blur1" />
                <feGaussianBlur stdDeviation={strength.wideBlur} result="blur2" />
        ...
        <g strokeLinecap="round" strokeLinejoin="round">
          ...
          <path
            d="M 140 185 Q 200 170 260 185 L 250 270 Q 200 275 150 270 Z"
            style={zoneStyle(upperTorso, zoneScores.upperTorso, weeklyTarget)}
          />

          <path
            d="M 151 280 Q 200 285 249 280 L 247 360 Q 200 365 153 360 Z"
            style={zoneStyle(midTorso, zoneScores.midTorso, weeklyTarget)}
          />

          <path
            d="M 154 370 Q 200 375 246 370 L 245 420 Q 200 450 155 420 Z"
            style={zoneStyle(lowerTorso, zoneScores.lowerTorso, weeklyTarget)}
          />

          <path
            d="M 115 205 Q 135 320 115 425 A 15 15 0 0 1 85 420 Q 100 310 93 210 A 15 15 0 0 1 115 205 Z"
            style={zoneStyle(arms, zoneScores.arms, weeklyTarget)}
          />

          <path
            d="M 285 205 Q 265 320 285 425 A 15 15 0 0 0 315 420 Q 300 310 307 210 A 15 15 0 0 0 285 205 Z"
            style={zoneStyle(arms, zoneScores.arms, weeklyTarget)}
          />

          <path
            d="M 143 435 L 178 435 Q 175 550 185 660 A 22 22 0 0 1 138 660 Q 150 540 143 435 Z"
            style={zoneStyle(legs, zoneScores.legs, weeklyTarget)}
          />

          <path
            d="M 222 435 L 257 435 Q 250 540 262 660 A 22 22 0 0 1 215 660 Q 225 550 222 435 Z"
            style={zoneStyle(legs, zoneScores.legs, weeklyTarget)}
          />
        </g>
      </svg>

      <div className="zone-list compact-zone-list">
        {zones.map((zone) => {
